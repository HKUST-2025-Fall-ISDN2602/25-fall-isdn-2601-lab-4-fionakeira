...
#define TOUCH_PIN 32  // Replace the ? with the GPIO touch pin you selected 
#define THRESHOLD 20   // Replace the ? with the reading when the pin is touched from Lab 3
